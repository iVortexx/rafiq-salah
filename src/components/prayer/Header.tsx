...
import { Languages, ChevronDown, SunIcon, MoonIcon, Settings as SettingsIcon, Home as HomeIcon } from "lucide-react"
...
const USFlag = memo(() => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 24 18" className="rounded-sm">
    ...
    <path
      fill="#FFF"
      d="M1.5 1.5h1v1h-1z m3 0h1v1h-1z m3 0h1v1h-1z m3 0h1v1h-1z m-9 2h1v1h-1z m3 0h1v1h-1z m3 0h1v1h-1z m3 0h1v1h-1z m-9 2h1v1h-1z m3 0h1v1h-1z m3 0h1v1h-1z m3 0h1v1h-1z"
    />
...
const EgyptFlag = memo(() => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 9 6" className="rounded-sm">
    ...
    <path
      fill="#CDBA00"
      d="M4.5 2.5c.2 0 .4.2.4.4v.2h-.8v-.2c0-.2.2-.4.4-.4zm0 .2c.1 0 .2.1.2.2v.1h-.4v-.1c0-.1.1-.2.2-.2zM4.1 3.3h.8v.2h-.8z"
    />
  </svg>
))
    ...
    <header className="container mx-auto px-4 py-4 flex justify-between items-center">
      <div className="flex items-center gap-3">
        <Link href="/" aria-label="Home">
          <HomeIcon className="h-6 w-6 text-muted-foreground hover:text-primary transition" />
        </Link>
      ...
      <div className="flex items-center gap-2">
        ...
        <Link href="/settings" aria-label="Settings" className="ml-2">
          <SettingsIcon className="h-6 w-6 text-muted-foreground hover:text-primary transition" />
        </Link>
      </div>
    </header>
  )

...
export const LocationForm = memo(
  ({
    ...
    const selectedCountryData = useMemo(
      () => countries.find((c) => c.name === selectedCountry || c.arabicName === selectedCountry),
      [selectedCountry],
    )
                      ...
                      return (
                        ...
                        >
                          <Check
                            className={cn(
                              "me-2 h-4 w-4",
                              selectedCountryData && getCountryDisplayName(selectedCountryData) === countryDisplayName
                                ? "opacity-100"
                                : "opacity-0",
                            )}
                          />
                      ...
                      return (
                        ...
                        >
                          <Check
                            className={cn(
                              "me-2 h-4 w-4",
                              selectedCityData && getCityDisplayName(selectedCityData) === cityDisplayName
                                ? "opacity-100"
                                : "opacity-0",
                            )}
                          />
